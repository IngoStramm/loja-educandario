...
- Loja Educandário (Nome do plugin)
- loja-educandario (nome dos arquivos, nome do text domain e slug da url do repositório)
- LED_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- led_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Loja Educandário, através do próprio sistema de atualizações do WordPress
